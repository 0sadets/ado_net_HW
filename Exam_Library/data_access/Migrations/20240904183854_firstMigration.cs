    ...
    public partial class firstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActionBook", x => new { x.ActionsId, x.BooksId });
                    table.ForeignKey(
                        name: "FK_ActionBook_Actions_ActionsId",
                        column: x => x.ActionsId,
                        principalTable: "Actions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActionBook_Books_BooksId",
                        column: x => x.BooksId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfReservetion = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clients_LibraryId",
                table: "Clients",
                column: "LibraryId");

            migrationBuilder.CreateIndex(
                name: "IX_Reserveds_BookId",
                table: "Reserveds",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_Reserveds_ClientId",
                table: "Reserveds",
                column: "ClientId");
